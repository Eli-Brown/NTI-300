...
echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('eli', 'eli@newproject.com', 'P@ssw0rd1')" | python manage.py shell
